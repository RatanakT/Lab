...
if (isset($_POST['submit'])) {
    ...
    $query = $fluent->from('useraccount')->where('username',$username)->where('email',$email)->where('password',$password);
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="text-center mt-3">
                            <a class='btn btn-primary btn-sm' href='index.php'>Login</a><br>
